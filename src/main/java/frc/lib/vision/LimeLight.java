...
public class LimeLight {
    ...
    public double getTargetPoseInRobotPoseRY() {
    ...
    public double getDistanceLLToGoal() {
        ...
        if (getPipelineInt() == LimelightConstants.pipeNu_hp45_april)
            goalHeightCm = LimelightConstants.hp_april_heightCm;
        else if (getPipelineInt() == LimelightConstants.pipeNu_lower_reflective)
            goalHeightCm = LimelightConstants.node_april_heightCm;
        else if (getPipelineInt() == LimelightConstants.pipeNu_higher_reflective)
            goalHeightCm = LimelightConstants.node_april_heightCm;
        else
            goalHeightCm = LimelightConstants.node_april_heightCm;
